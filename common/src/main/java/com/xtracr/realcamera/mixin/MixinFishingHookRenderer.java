...
public abstract class MixinFishingHookRenderer {
    ...
    private boolean realcamera$redirectIsFirstPerson(CameraType instance, Operation<Boolean> original, Player owner) {
        if (DisableHelper.RENDER_HANDS.disabled(owner)) return false;
