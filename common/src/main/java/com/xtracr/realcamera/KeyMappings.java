...
public final class KeyMappings {
    ...
    static {
        ...
        createKeyMapping("adjustUP", client -> ConfigFile.config().adjustOffsetY(1, client.player));
        createKeyMapping("adjustDOWN", client -> ConfigFile.config().adjustOffsetY(-1, client.player));
        ...
        createKeyMapping("adjustFRONT", client -> ConfigFile.config().adjustOffsetX(1, client.player));
        createKeyMapping("adjustBACK", client -> ConfigFile.config().adjustOffsetX(-1, client.player));
