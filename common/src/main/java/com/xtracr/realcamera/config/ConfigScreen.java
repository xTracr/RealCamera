...
public class ConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        SubCategoryBuilder classicCameraOffset = entryBuilder.startSubCategory(new TranslatableText(CATEGORY + "cameraOffset"))
                .setTooltip(new TranslatableText(TOOLTIP + "classicOffset"), new TranslatableText(TOOLTIP + "classicOffset_n"));
        ...
        compats.addEntry(entryBuilder.startBooleanToggle(new TranslatableText(OPTION + "useModModel"), config.compats.useModModel)
                .setDefaultValue(false)
                .setTooltip(new TranslatableText(TOOLTIP + "useModModel", new LiteralText((config.compats.useModModel ? RealCameraCore.getStatus() : "Disabled")).styled(
        ...
        disableModWhen.add(entryBuilder.startBooleanToggle(new TranslatableText(OPTION + "fallFlying"), config.disable.fallFlying)
                ...
                .build());
        disableModWhen.add(entryBuilder.startBooleanToggle(new TranslatableText(OPTION + "swimming"), config.disable.swimming)
                .setDefaultValue(false)
        ...
        disableModWhen.add(entryBuilder.startBooleanToggle(new TranslatableText(OPTION + "sleeping"), config.disable.sleeping)
                ...
                .build());
        disableModWhen.add(entryBuilder.startBooleanToggle(new TranslatableText(OPTION + "screenOpened"), config.disable.screenOpened)
                .setDefaultValue(false)
