...
public class ConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        binding.addEntry(entryBuilder.startBooleanToggle(Text.translatable(OPTION+"lockRolling"), config.binding.lockRolling)
            ...
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"cameraX"), config.binding.cameraX)
            ...
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"cameraY"), config.binding.cameraY)
            ...
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"cameraZ"), config.binding.cameraZ)
            ...
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referX"), config.binding.referX)
            .setDefaultValue(3.25D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referX"))
            .setSaveConsumer(d -> config.binding.referX = d)
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referY"), config.binding.referY)
            .setDefaultValue(2.0D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referY"))
            .setSaveConsumer(d -> config.binding.referY = d)
            .build());
        binding.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referZ"), config.binding.referZ)
            .setDefaultValue(0.0D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referZ"))
        ...
        classic.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"cameraZ"), config.classic.cameraZ)
            ...
            .build());
        classic.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referX"), config.classic.referX)
            .setDefaultValue(3.25D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referX"))
            ...
            .build());
        classic.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referY"), config.classic.referY)
            .setDefaultValue(2.0D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referY"))
            ...
            .build());
        classic.addEntry(entryBuilder.startDoubleField(Text.translatable(OPTION+"referZ"), config.classic.referZ)
            .setDefaultValue(0.0D)
            .setMin(ModConfig.MIN_DOUBLE)
            .setMax(ModConfig.MAX_DOUBLE)
            .setTooltip(Text.translatable(TOOLTIP+"referZ"))
