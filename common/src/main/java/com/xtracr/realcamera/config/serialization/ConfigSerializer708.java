...
final class ConfigSerializer708 implements ConfigSerializer {
    ...
    private static OffsetConfig readOffsetConfig(FriendlyByteBuf byteBuf) {
        ...
        OffsetConfig.Posture standing = new OffsetConfig.Posture().read(byteBuf);
        OffsetConfig.Posture sneaking = new OffsetConfig.Posture().read(byteBuf);
        OffsetConfig.Posture swimming = new OffsetConfig.Posture().read(byteBuf);
        OffsetConfig.Posture crawling = new OffsetConfig.Posture().read(byteBuf);
        return new OffsetConfig(scale, x, y, z, standing, sneaking, swimming, crawling);
    }
