...
public record BindTarget(
    ...
    private static BindTarget vanillaTarget(String name, int priority, boolean shouldBind) {
        ...
        offsets.x = -0.1f;
        DisableConfig playerHead = new DisableConfig("player_head", textureId, false, List.of(new UVRectangle(0, 0, 1.0f, 0.25f)), true);
        DisableConfig dragonHead = new DisableConfig("dragon_head", "minecraft:textures/entity/enderdragon/dragon.png", true, List.of(), true);
