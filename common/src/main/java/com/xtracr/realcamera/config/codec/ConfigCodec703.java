...
import com.xtracr.realcamera.config.codec.utli.ByteBufCodecs;
import com.xtracr.realcamera.config.codec.utli.CodecUtil;
import com.xtracr.realcamera.config.codec.utli.StreamCodec;
import io.netty.buffer.ByteBuf;

import java.util.List;

final class ConfigCodec703 {
    static final StreamCodec<ByteBuf, TargetConfig> TARGET_CONFIG_CODEC = CodecUtil.composite(
    ...
    static final StreamCodec<ByteBuf, BindConfig> BIND_CONFIG_CODEC = StreamCodec.of(
            ByteBufCodecs.BYTE,
            bindConfig -> {
                byte bindFlags = 0;
    ...
    static final StreamCodec<ByteBuf, OffsetConfig> OFFSET_CONFIG_CODEC = CodecUtil.composite(
    ...
    static final StreamCodec<ByteBuf, List<UVRectangle>> UV_RECTANGLES_CODEC = StreamCodec.list(CodecUtil.composite(
    ...
    static final StreamCodec<ByteBuf, List<DisableConfig>> DISABLE_CONFIGS_CODEC = StreamCodec.list(CodecUtil.composite(
    ...
    static final StreamCodec<ByteBuf, BindTarget> CODEC = CodecUtil.composite(
