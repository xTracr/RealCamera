...
public class ModelViewScreen extends Screen {
    ...
    protected void renderEntityWithAnalyser(GuiGraphics graphics, float x, float y, int mouseX, int mouseY, Vector3f offset, Quaternionf quaternionf, LivingEntity entity) {
        ...
        entityRenderDispatcher.render(entity, 0, -entity.getBbHeight() / 2.0f, 0, 1.0f, graphics.pose(), analyser, 0xF000f0);
        ...
        analyser.forEachRecord(record -> ModelAnalyser.renderVertices(record.vertices(), ((GuiGraphicsAccessor) graphics).getBufferSource().getBuffer(record.renderType())));
        graphics.flush();
