...
public final class ItemSelectorEntriesNeoForge {
    private ItemSelectorEntriesNeoForge() {
    }

    public static void register() {
        ItemSelectorEntries.setProvider(ItemSelectorEntriesNeoForge::createEntry);
    }
